...
logo_path = r"C:\Users\sumitkumar\OneDrive - Informatica\Sumit\Python\logo.png"
photo_path = r"C:\Users\sumitkumar\OneDrive - Informatica\Sumit\Python\photo.png"
sign_path = r"C:\Users\sumitkumar\OneDrive - Informatica\Sumit\Python\signature.png"
output_front = r"C:\Users\sumitkumar\OneDrive - Informatica\Sumit\Python\ID_front.png"
output_back = r"C:\Users\sumitkumar\OneDrive - Informatica\Sumit\Python\ID_back.png"

# Sample college/student info
college = {
    "name": "Maharana Pratap Engineering College",
    "address": "Kothi, Mandhana, Kanpur, Uttar Pradesh 209217",
...
def generate_front():
    ...
    card.paste(sign, (start_x + 1, y + 5), sign)
    draw.text((start_x, y + 70), "Authorized Signatory", font=small_font, fill=SIGN_TEXT_COLOR)
...
# --- Generate Back ID with QR & Barcode ---
def generate_back():
    card = Image.new("RGB", (CARD_WIDTH, CARD_HEIGHT), BG_COLOR)
    draw = ImageDraw.Draw(card)
    ...
    try:
        ...
        bar = CODE128(student["roll"], writer=ImageWriter(), add_checksum=False)
    ...
    # Text fields: address, contact, emergency, rules
    x0 = 50
    y0 = 200
    lines = [
